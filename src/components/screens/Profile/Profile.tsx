        ...
        <main className={"p-4"}>
            ...
            <header className={"flex gap-10 mb-8"}>
                <img className={"rounded-[50%] h-24"}
                     src={tg?.initDataUnsafe.user?.photo_url || "https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?size=338&ext=jpg&ga=GA1.1.1412446893.1704931200&semt=ais"}
                     alt=""/>
                <div>
